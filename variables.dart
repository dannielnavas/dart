void main() {
  ...
  final String nombreFinal =
      'John'; // este no cumple lo de const, funciona igual que const no puede ser modificado
  const String nombreConst =
      'John'; // valor conocido en tiempo de compilación, funciona como js es una constante no puede ser modificada

  // dinamic

  dynamic variableDinamica =
      'John'; // puede cambiar de tipo de dato, usado en colecciones
